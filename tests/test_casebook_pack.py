"""Regression checks for the rookline casebook."""
...
from casebook.harness import assert_expected, rookline_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(rookline_summary(), assert_expected())
