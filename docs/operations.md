...
`rookline` is centered on chess and game engines work in Python. The technical target is: Implement FEN parsing, legal candidate move scoring, and UCI-style command handling.
...
The score is deterministic. The current threshold is 165. Risk has a penalty of 5, latency has a penalty of 4, and weight contributes a bonus of 2.
